    ...
    <footer className="bg-[#2D1B14] text-stone-300 py-10">
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="text-center sm:text-left">
            <div className="flex items-center gap-2 justify-center sm:justify-start mb-2">
              ...
              <span className="font-semibold text-white text-sm">{t.headerTitle}</span>
            </div>
            <p className="text-xs text-stone-400 max-w-xs">{t.footerTagline}</p>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-stone-800 text-center">
          <p className="text-[11px] text-stone-500">© {new Date().getFullYear()} Enllaç Digital. Tots els drets reservats.</p>
        </div>
      </div>
    </footer>
  );
