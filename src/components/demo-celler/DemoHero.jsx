...
export default function DemoHero({ t, onDemoClick }) {
  return (
    <section className="relative py-12 sm:py-16 bg-gradient-to-b from-[#FAF7F2] to-white overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#722F37]/10 text-[#722F37] text-xs font-medium mb-5">
          <span className="w-1.5 h-1.5 rounded-full bg-[#722F37] animate-pulse" />
          Assistent en viu
        </div>

        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#2D1B14] leading-tight mb-5">
          {t.heroTitle}
        </h1>

        <p className="text-sm sm:text-base text-stone-600 max-w-2xl mx-auto mb-8 leading-relaxed">
          {t.heroSubtitle}
        </p>
